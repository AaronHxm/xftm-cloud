define(function(require){
	...
	var loginUserKey = window.top.LOGIN_USER_KEY || 'userInfo';
	 ...
	 */
	if (!top.userInfodd) {
		var userInfo = localStorage.getItem(loginUserKey);
		var peopleInfo = null;
		var peopleName = null;
		...
		if (userInfo) {
			...
			top.userInfodd = {
				...
				sysAdmin: userInfo.sysadmin, 		// 是否为系统管理员
				...
				isLoadModels: userInfo.isLoadModels		// 是否加载模型
			};
		} else {
