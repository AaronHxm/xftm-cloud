define(function(require){
	...
	Flatpickr.l10n.months.shorthand = ['一月', '二月', '三月', '四月', '五月', '六月', '七月','八月', '九月', '十月', '十一月', '十二月'];
		...
		var datecomponent = vue.extend({
			...
			template :'<div class="input icon date-input" style="height: 34px;">'
				+ '<input type="text" data-input v-model="val" readonly  placeholder="{{tip}}" style="position: absolute;height: 32px;line-height: 32px;">'
