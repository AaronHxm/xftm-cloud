	...
	var base={
			init:function(selector,options){
				...
				options = $.extend({
					...
					pageList: options.pageList || [10,20,30],
					searchAlign:'left',
					//showRefresh:true,
			...
			method:function(method,parameter,selector){
				var tableObj = $table;
				if(selector) tableObj = $("#"+selector);
				return tableObj.bootstrapTable(method, parameter);
			}
	};
	return base;
});