define(function(require) {
	...
	var model = new vue({
		...
		data:{
			dangerResInfolist :[ 
		         {'type':'管制刀具','name':'水果刀','number':2,'applyer':'李某','dept':'第二监狱','time':'2017-12-08 13:05','reason':''},
	             {'type':'管制刀具','name':'匕首','number':1,'applyer':'王某','dept':'第三监狱','time':'2017-12-08 14:05','reason':''},
	             {'type':'易燃易爆','name':'火机','number':1,'applyer':'赵某','dept':'第四监狱','time':'2017-12-09 12:03','reason':''},
	             {'type':'易燃易爆','name':'煤油','number':1,'applyer':'王某','dept':'第五监狱','time':'2017-12-09 15:05','reason':''},
	             {'type':'毒品','name':'吗啡','number':1,'applyer':'李某','dept':'第六监狱','time':'2017-12-09 18:05','reason':''}
		     ],
		     dangerRecAreaData:[
		     ...
		     dangerTimeSprade:[
                  {'prisonName':'第二监狱','count':1},
			      {'prisonName':'第三监狱','count':1},
			      {'prisonName':'第四监狱','count':1},
			      {'prisonName':'第五监狱','count':1},
			      {'prisonName':'第六监狱','count':1},
			      {'prisonName':'XX监狱','count':0},
			      {'prisonName':'XX监狱','count':0},
			      {'prisonName':'XX监狱','count':0}
			  ],
			  dangerPei: [
...
//			    center: ['45%','60%'],
	...
	function loadDangerRecArea(){
		...
		dangerResRec.on('click', function(param){
			...
			dialog.open({targetId:'danger_panel',title:'危险品进监记录',w: 90, h: 90});
			qryDangerResInfo(list1);
		});
	}
