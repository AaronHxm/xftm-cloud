	...
	var model = new vue({
		...
		data : {
			...
			list2 : {
				'rows' : [ {
					"rn" : 1,
					"time" : "2017-12-10 07:09:34",
					"dept" : "第二监狱",
					"titie" : "二监要情日报"
				}, {
					"rn" : 2,
					"time" : "2017-12-10 07:39:34",
					"dept" : "第一监狱",
					"titie" : "一监要情日报"
				}, {
					"rn" : 3,
					...
					"rn" : 4,
					"time" : "2017-12-09 08:09:34",
					"dept" : "xx监狱",
					"titie" : "xx要情日报"
				}, {
					"rn" : 5,
					"time" : "2017-12-08 08:09:34",
					"dept" : "第二监狱",
					"titie" : "二监要情日报"
				} ],
				'total' : 6
			...
			list3:[
					  ...
					  {"rn":2,id:32236,name:'xx监狱',rs:497,zg:256,yj:17,cc:3,qj:0},
					  {"rn":3,id:32237,name:'xx监狱',rs:950,zg:316,yj:38,cc:31,qj:12},
					  {"rn":4,id:32238,name:'xx监狱',rs:570,zg:262,yj:2,cc:37,qj:6},
					  {"rn":5,id:322310,name:'xx监狱',rs:542,zg:196,yj:10,cc:0,qj:15},
					  {"rn":6,id:322314,name:'xx监狱',rs:490,zg:131,yj:15,cc:17,qj:10},
					 {"rn":7,id:322315,name:'xx监狱',rs:760,zg:297,yj:20,cc:15,qj:6},
					 {"rn":8,id:322316,name:'xxx监狱',rs:390,zg:121,yj:14,cc:15,qj:7},
					  {"rn":9,id:322317,name:'xx监狱',rs:790,zg:361,yj:16,cc:15,qj:5},
					  ...
					  {"rn":13,id:32234,name:'xxx监狱',rs:689,zg:300,yj:26,cc:15,qj:5},
					  {"rn":14,id:32231,name:'xx监狱',rs:1192,zg:495,yj:30,cc:20,qj:10},
...
var zaiyaOption = {
	...
	series : [
			...
			},
			{
				...
				data : [ 4, 18, 7, 12, 3, 9, 11, 21, 19, 17,
						13, 20 ]
			}, ]
};
...
//		               '#FF2DFF',
	...
	//		    center: ['45%','60%'],
		...
		var huijian = echarts.init(document.getElementById('huijian'));
		//指定图表的配置项和数据
		var huijianOption6 = {
				color: [
						   '#FF5959',
...
//			               '#FF2DFF',
		...
		//		    center: ['45%','60%'],
			...
			huijian.setOption(huijianOption6);
