define(function(require){
	...
	var model = new vue({
		...
		data:{
			...
			nearbyUnit :[
						 {'id':'1','name':'xx市消防队','phone':'0571 57867734'},
						 {'id':'2','name':'xx市警察局','phone':'0571 57867734'}, 
						 {'id':'3','name':'xx市交通管理支队','phone':'0571 57867734'},  
						 {'id':'4','name':'xx市第一人民医院','phone':'0571 57867734'}
			],
			eventInfo: {
				'unitName':'省九十九监狱',
				'eType':'安全演练',
			...
			title:[
			       ...
			       {'titleName':'当前应急事件处理步骤','infoAttrName':'imp','infoVal':''}
