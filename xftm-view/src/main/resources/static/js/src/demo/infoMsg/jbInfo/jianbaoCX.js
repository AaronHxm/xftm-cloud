define(function(require){
	...
	var model = new vue({
		...
		data:{
			...
			jbListList:[
	             {'orgName':'第二监狱','date':'2017-12-09','writeTime':'2017-12-09 09:55','writePolice':'李某某','neirong':'当日狱情简报'},
	             {'orgName':'第三监狱','date':'2017-12-09','writeTime':'2017-12-09 09:56','writePolice':'赵某某','neirong':'当日违纪简报'},
	             {'orgName':'第四监狱','date':'2017-12-09','writeTime':'2017-12-09 09:45','writePolice':'孙某某','neirong':'当日违规简报'},
	             {'orgName':'第五监狱','date':'2017-12-09','writeTime':'2017-12-09 09:35','writePolice':'王某某','neirong':'当日巡查简报'},
	             {'orgName':'第六监狱','date':'2017-12-09','writeTime':'2017-12-09 09:25','writePolice':'高某某','neirong':'当日设施运行简报'},
	             {'orgName':'第二监狱','date':'2017-12-09','writeTime':'2017-12-09 09:55','writePolice':'李某某','neirong':'当日交接班简报'},
	             {'orgName':'第三监狱','date':'2017-12-09','writeTime':'2017-12-09 09:56','writePolice':'赵某某','neirong':'当日狱情简报'},
	             {'orgName':'第四监狱','date':'2017-12-09','writeTime':'2017-12-09 09:45','writePolice':'孙某某','neirong':'当日违规简报'},
	             {'orgName':'第五监狱','date':'2017-12-09','writeTime':'2017-12-09 09:35','writePolice':'王某某','neirong':'当日狱情简报'},
	             {'orgName':'第六监狱','date':'2017-12-09','writeTime':'2017-12-09 09:25','writePolice':'高某某','neirong':'当日违纪简报'}
			]
		},
		search:{
			'startdate':'',
		...
		methods:{
			openSearchPanel:function(){
				...
				dialog2 = dialog.open({targetId:'search_panel',title:'简报查询',w:"500",h:"350"});
		...
		table.init('table', {
			...
			columns: [[
	            ...
	            onClickCell:function(field,value,row,$element){
		        	 ...
		        	 if(field == "shenbian"){
		        		 value = '<a class="hbtn btn_primary btn_large"><span>已审核</span></a>';
		        	 }
		        	 if(field == "shenhe"){
		        		 vue.nextTick(function () {
		        			 var dateList = row.date.split("-");
